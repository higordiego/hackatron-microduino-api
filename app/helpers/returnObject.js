...
module.exports = ({
    ...
    returnError: res => err => res.status(400).json(err),
    ...
    returnListSuccess: res => object => res.status(200).json({count: object.count, pages: object.pages, data: object.data}),

    returnListOneSuccess: (res) => object => res.status(200).json(object)
